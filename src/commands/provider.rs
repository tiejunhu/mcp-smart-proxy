...
fn provider_hooks(provider_name: &'static str) -> ProviderHooks {
    match provider_name {
        ...
        "crush" => ProviderHooks {
            provider_name,
            import_source: ImportSource::Crush,
            load_import_plan: load_crush_servers_for_import,
            install_server: install_crush_mcp_server,
            replace_servers: replace_crush_mcp_servers,
            restore_servers: restore_crush_mcp_servers,
            import_load_provider_stage: "cli.import.crush.load_provider",
            import_load_source_stage: "cli.import.crush.load_source",
